document.addEventListener("DOMContentLoaded", () => {
    ...
    const WEDDING_TIME =
        new Date("2026-07-26T18:00:00+02:00").getTime();
    ...
    const GOOGLE_SCRIPT_URL =
        "https://script.google.com/macros/s/AKfycbx-gIXZ4rAANv5L8zXgpT9uVe_o-CkBHHjwQmORKPuTN-yyUumGp_aGW_cgtr4Ilh_U/exec";
    ...
    window.copyToClipboard = async function (id) {
        ...
        try {
            ...
            // Fallback for older/quirky mobile browsers: off-screen textarea + execCommand
            try {
                ...
                alert('Το αντίγραφο απέτυχε. Παρακαλώ αντιγράψτε χειροκίνητα.');
                return;
            }
        }

        // Visual feedback (same behavior as before)
        if (btn) {
